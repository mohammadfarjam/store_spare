...
<section class="story-area ptb-50">
    <div class="container">
        <div class="story-title">
            <h2>ما تمام فعالیتهای خدماتی را با توجه به مشتری انجام می دهیم</h2>
        </div>

        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="story-image">
                    <a href="https://www.youtube.com/watch?v=BVMsRltq2yU" class="video-btn popup-youtube">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="story-content">
                    <h3>داستان ما</h3>
                    <b>لورم ایپسوم ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم استاندارد صنعت بوده است. لورم ایپسوم ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم استاندارد صنعت بوده است.</b>
...
<!-- Start Vision Area -->
<section class="vision-area ptb-50">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
...
<section class="fun-facts-area pt-50 pb-20">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-fun-fact">
                    <h3>
                        <span class="odometer" data-count="363">00</span>
                    </h3>
                    <p>مشتریان عمومی</p>
                </div>
            </div>

                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone_number" id="phone_number" class="form-control" required data-error="لطفا تلفن خود را وارد کنید">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subjects" id="subjects" class="form-control" required data-error="لطفا موضوع خود را وارد کنید">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>

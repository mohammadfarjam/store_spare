                        ...
                        <table class="table table-bordered">
                            ...
                            <tr class="top-class">
                                <td class="product-thumbnail">
                                    ...
                                    <a href="#">
                                        <img src="frontend/image/battry.jpg" alt="item">
                                    </a>
                                </td>

                                <td class="product-name">
                                    <a href="products-details.html">باتری 63 آمپر</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="product-name">
                                    <a href="products-details.html">دیسک و صفحه </a>
                                </td>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    ...
                                    <a href="#">
                                        <img src="frontend/image/silandr.jpg" alt="item">
                                    </a>
                                </td>

                                <td class="product-name">
                                    <a href="products-details.html">بلوک سیلندر</a>
                                </td>

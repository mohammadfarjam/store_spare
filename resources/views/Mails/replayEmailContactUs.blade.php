...
<div>
    ...
    <p style="font-size: 11pt;padding: 0 20px;color:black;">{{$data->message}}</p>

    <p  style="font-size: 12pt;font-weight:700;">پاسخ :</p>
    <p style="font-size: 11pt;margin-right: 30px;color:black;margin-bottom: 50px;">{{$data->replay_to_user}}</p>

                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="message" id="message" cols="30" rows="5" required data-error="لطفا پیام خود را بنویسید" class="form-control"></textarea>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone_number" id="phone_number" class="form-control" required data-error="لطفا تلفن خود را وارد کنید" maxlength="11">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subject" id="subject" class="form-control" required data-error="لطفا موضوع خود را وارد کنید">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="captcha">
                                ...
                                <button class="btn btn-success" onclick="refresh_captcha()">ref</button>
                            </div>
            ...
            <div class="col-lg-5 col-md-12">
                <div class="contact-information">
                    ...
                    <ul class="contact-list">
                        <li><i class='bx bx-map'></i> آدرس: <span>ایران ، استان تهران ، میدان آزادی ، خیابان 9</span></li>
                        <li><i class='bx bx-phone-call'></i> تلفن: <a href="tel:021-12345678">021-12345678</a></li>
                        <li><i class='bx bx-envelope'></i> ایمیل: <a href="mailto:hello@ejon.com">hello@ejon.com</a></li>
                    </ul>
...
$('.captcha span').html(refreshCaptcha.captcha)
    ...
    function submit_form() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {message, name, email, phone, subject},

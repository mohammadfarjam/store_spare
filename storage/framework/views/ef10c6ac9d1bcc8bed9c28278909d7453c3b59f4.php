    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="<?php echo e(route('dashboard')); ?>" aria-expanded="true" class="dropdown-toggle">
                        <div class="active">
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="posts" data-parent="#accordionExample">
                        <li>
                            <a href="<?php echo e(route('posts.index')); ?>">همه محصولات </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('posts.create')); ?>"> افزودن محصول جدید </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('products.sold')); ?>"> کالاهای فروخته شده </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="comments" data-parent="#accordionExample">
                        <li>
                            <a href="<?php echo e(route('users.index')); ?>">نظرات محصولات </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('comments_contactUs.index')); ?>"> نظرات تماس با ما </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="categories" data-parent="#accordionExample">
                        <li>
                            <a href="<?php echo e(route('categories.index')); ?>">همه دسته بندی ها </a>
                        </li>
                    </ul>

                    <ul class="collapse submenu list-unstyled" id="categories" data-parent="#accordionExample">
                        <li>
                            <a href="<?php echo e(route('categories.create')); ?>"> افزودن دسته بندی جدید </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="attributes" data-parent="#accordionExample">
                        <li>
                            <a href="<?php echo e(route('attributes.index')); ?>">  ویژگی ها </a>
                        </li>
                    </ul>

                    <ul class="collapse submenu list-unstyled" id="attributes" data-parent="#accordionExample">
                        <li>
                            <a href="<?php echo e(route('attributes.create')); ?>"> افزودن ویژگی جدید </a>
                        </li>
                    </ul>
                </li>

                <li class="menu">
                    <a href="<?php echo e(route('brands.index')); ?>" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="<?php echo e(route('sliders.index')); ?>" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="<?php echo e(route('discount.index')); ?>" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="<?php echo e(route('managment.index')); ?>" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled" id="setting" data-parent="#accordionExample">
                        <li>
                            ...
                            <ul class="collapse list-unstyled sub-submenu" id="sm2" data-parent="#setting">
                                <li>
                                    <a href="<?php echo e(route('contactUs.index')); ?>"> تماس با ما</a>
                                </li>

                                <li>
                                    <a href="<?php echo e(route('sms.index')); ?>"> ارسال پیامک</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled sub-submenu" id="sm3" data-parent="#setting">
                                <li>
                                    <a href="<?php echo e(route('name_store.index')); ?>"> نام فروشگاه</a>
                                </li>
                            </ul>
                        </li>
...
<?php /**PATH C:\store_spare\resources\views/Admin/Layout/index.blade.php ENDPATH**/ ?>